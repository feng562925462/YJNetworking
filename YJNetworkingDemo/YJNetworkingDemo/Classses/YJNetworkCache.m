 ...
 */
+ (void)yj_setHttpCache:(id)httpData
              urlString:(NSString *)urlString
             parameters:(NSDictionary *)parameters
{
    NSString *cacheKey = [self yj_cacheWithUrlString:urlString parameters:parameters];
...
/**
 ...
 @return 缓存的服务器数据
 */
+ (id)yj_httpCacheWithUrlString:(NSString *)urlString
                     parameters:(NSDictionary *)parameters
{
    NSString *cacheKey = [self yj_cacheWithUrlString:urlString parameters:parameters];
 ...
 */
+ (void)yj_httpCacheWithUrlString:(NSString *)urlString
...
+ (NSString *)yj_cacheWithUrlString:(NSString *)urlString
                         parameters:(NSDictionary *)parameters
{
    if (!parameters)
    {
...
/**
 ...
 @return 总对象的大小（以M为单位）。
 */
+ (CGFloat)yj_getAllHttpCacheSize
{
