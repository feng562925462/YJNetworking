#
#  Be sure to run `pod spec lint YJNetworking.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  oc基于AFNetWorking的二次封装
                   DESC

  s.homepage     = "https://github.com/feng562925462/YJNetworking"
  ...
  s.source       = { :git => "https://github.com/feng562925462/YJNetworking.git", :tag => s.version }
